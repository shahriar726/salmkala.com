...
class AddressController extends Controller
{
    public function addressAndDelivery()
    {
        //check profile
        $user = Auth::user();
        $provinces = IranProvince::get();
        $IranCities = IranCity::get();
        ...
        return view('customer.sales-process.address-and-delivery', compact('cartItems', 'provinces','deliveryMethods','IranCities'));
    }
    ...
    public function chooseAddressAndDelivery(ChooseAddressAndDeliveryRequest $request)
    {
        ...
        //commonDiscount ma faqaht ba first common discount kar darim na baqhie
        ...
        //ba tavajo be inputi ke goftam update bokon da qhyre in soorat create bokon
