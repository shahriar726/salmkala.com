...
|
*/
//Start with prefix admin and with name space Admin in which folder name in Admin
Route::middleware(['role:super_admin|super_sh|super_host'])->prefix('admin')->group(function() {
    ...
    Route::prefix('market')->group(function() {
        ...
        Route::prefix('category')->group(function(){
            ...
            Route::get('/show_in_menu/{productCategory}', [CategoryController::class, 'show_in_menu'])->name('admin.market.category.show_in_menu');
        ...
        Route::prefix('order')->group(function(){
            ...
            Route::get('/change-payment-status/{order}', [OrderController::class, 'changePaymentStatus'])->name('admin.market.order.changePaymentStatus');
    ...
    Route::prefix('user')->group(function() {
        ...
        Route::prefix('admin-user')->group(function(){
            ...
            Route::delete('/users/{admin}/roles/{role}', [AdminUserController::class, 'removeRole'])->name('admin.user.admin-user.users.roles.remove');
...
//            Route::post('/edit/{role}/permissions', [RoleController::class, 'givePermission'])->name('admin.user.role.permissions');
        ...
        Route::prefix('permission')->group(function(){
            ...
            Route::post('/permissions/{permission}/roles', [PermissionController::class, 'assignRole'])->name('admin.user.permissions.roles');
            Route::delete('/permissions/{permission}/roles/{role}', [PermissionController::class, 'removeRole'])->name('admin.user.permissions.roles.remove');
        });
    });
    ...
    Route::prefix('ticket')->group(function() {
        ...
        Route::prefix('admin')->group(function(){
            ...
            //click karadam bere to section admin
...
//    Route::get('login', [LoginRegisterController::class, 'loginForm'])->name('auth.customer.login-form');
...
Route::namespace ('Profile')->group(function () {
    ...
    Route::get('/show/{order}', [ProfileOrderController::class, 'show'])->name('customer.profile.order.show');
    Route::middleware('throttle:customer-destroy-order')->delete('/destroy/{order}', [ProfileOrderController::class, 'destroy'])->name('customer.profile.order.destroy');
    Route::get('/show/{order}/detail', [ProfileOrderController::class, 'detail'])->name('customer.profile.order.show.detail');
