                        ...
                        <section class="row">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description"  class="form-control form-control-sm @error('description') is-invalid @enderror" rows="6">
                                    {{ old('description') }}
                                </textarea>
                                </div>
                                @error('description')
                            ...
                            @if($errors->has('g-recaptcha-response'))
                                <h1 class="text-danger">{{$errors->first('g-recaptcha-response')}}</h1>
                                @endif
