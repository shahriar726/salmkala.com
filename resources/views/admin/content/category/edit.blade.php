                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $postCategory->name) }}">
                            </div>
                            @error('name')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            ...
                            @error('tags')
                            <span class="alert_required  text-white p-1 rounded @error('name') is-invalid @enderror" role="alert">
                                <strong>
                                    {{ $message }}
                                </strong>
                            </span>
