        ...
        <section class="main-body-container">
            ...
            <section class="card mb-3">
                ...
                <section class="card-body">
                    ...
                    <p class="card-text"> شماره مرجع : {{ $payment->paymentable->reference_code ?? '-' }}</p>
                    <p class="card-text"> تاریخ پرداخت : {{ jalaliDate($payment->paymentable->pay_date) ?? '-' }}</p>
                    <p class="card-text">  دریافت کننده : {{ $payment->paymentable->cash_receiver ?  $payment->user->fullName  : '-' }}</p>
                </section>
            </section>
