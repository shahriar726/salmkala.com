            ...
            <nav class="">
                ...
                <section class="  offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                    ...
                    <section class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel"><a class="text-decoration-none" href="{{route('customer.home')}}"><img  src="{{asset($setting->logo ) ?? '' }}" alt="{{$setting->title}}"></a></h5>
