                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9 mb-3">
                            <form action="{{route('customer.sales-process.update-cart')}}" id="cart_items" method="post" class="content-wrapper bg-white p-3 rounded-2">
                                @csrf
                                @php
                                    $totalProductPrice = 0;
                                    $totalDiscount = 0;
                                ...
                                @foreach ($cartItems as $cartItem)
                                    ...
                                    @php
                                    //be ezaye har mahsool byad qhymat cartItemProductPrice bekhone va ba tedad cart item ha + mishe
                                    // va  rikhte mishe to  => $totalProductPrice
                                     //qymat kole discount ham rikhtim to model cartItemProductDiscount
                                        ...
                                        <section class="align-self-start w-100">
                                            ...
                                            <section>
                                                <section class="cart-product-number d-inline-block ">
                                                    <button class="cart-number cart-number-down {{$cartItem->count === 1 ? 'disabled' : ''}}" @if($cartItem->count === 1) disabled @endif type="button">-</button>
...
{{--                                                ProductPrice Orginal Price--}}
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                <section class="d-flex justify-content-between align-items-center">
                                    <p class="text-muted">قیمت کالاها @if($cartItems->count() !== 0)({{  $cartItems->count()  }})@endif</p>
                                ...
                                <section class="">
{{--                                    elemnt id dar form ra pyada kon va submit kon--}}
