                                                        ...
                                                        <form class="row" method="post"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <select name="city_id" class="form-select form-select-sm"
                                                                        id="city-{{ $address->id }}">
                                                                    @foreach ($IranCities as $IranCity)
                                                                        <option {{ $address->city_id  == $IranCity->id ? 'selected' : '' }} value="{{ $IranCity->id }}"
                                                                                data-url="{{ route('customer.sales-process.get-cities', $IranCity->id) }}">
                                                                            {{ $IranCity->name }}</option>
                                                                    @endforeach
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-muted"><span id="product_price" data-product-original-price="{{$totalProductPrice}}">{{ priceFormat($totalProductPrice) }}</span> تومان
                                    </p>
                                </section>
